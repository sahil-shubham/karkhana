defmodule KarkhanaWeb.Router do
  @moduledoc """
  Router for Karkhana's observability dashboard and API.
  """
  ...
  pipeline :browser do
    ...
    plug(:put_root_layout, html: {KarkhanaWeb.Layouts, :root})
