defmodule Karkhana.LogFile do
  ...
  @handler_id :karkhana_disk_log
  @default_log_relative_path "log/karkhana.log"
  ...
  @spec configure() :: :ok
  def configure do
    log_file = Application.get_env(:karkhana, :log_file, default_log_file())
    max_bytes = Application.get_env(:karkhana, :log_file_max_bytes, @default_max_bytes)
    max_files = Application.get_env(:karkhana, :log_file_max_files, @default_max_files)
