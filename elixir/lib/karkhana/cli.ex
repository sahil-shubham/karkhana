defmodule Karkhana.CLI do
  ...
  defp runtime_deps do
    %{
      ...
      set_workflow_file_path: &Karkhana.Workflow.set_workflow_file_path/1,
      set_logs_root: &set_logs_root/1,
      set_server_port_override: &set_server_port_override/1,
      ensure_all_started: fn -> Application.ensure_all_started(:karkhana) end
    }
  end
  ...
  defp acknowledgement_banner do
    lines = [
      ...
      "Karkhana is not a supported product and is presented as-is.",
  ...
  defp set_logs_root(logs_root) do
    Application.put_env(:karkhana, :log_file, LogFile.default_log_file(logs_root))
    :ok
  end
  ...
  defp set_server_port_override(port) when is_integer(port) and port >= 0 do
    Application.put_env(:karkhana, :server_port_override, port)
    :ok
  end

  @spec wait_for_shutdown() :: no_return()
  defp wait_for_shutdown do
    case Process.whereis(Karkhana.Supervisor) do
      nil ->
