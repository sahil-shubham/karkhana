defmodule Karkhana.Orchestrator do
  @moduledoc """
  ...
  alias Karkhana.{AgentRunner, Config, StatusDashboard, Tracker, Workspace}
  ...
  defp terminate_task(pid) when is_pid(pid) do
    case Task.Supervisor.terminate_child(Karkhana.TaskSupervisor, pid) do
      :ok ->
        :ok
