defmodule Karkhana.Linear.Client do
  @moduledoc """
  Thin Linear GraphQL client for polling candidate issues.
  """

  require Logger
  alias Karkhana.{Config, Linear.Issue}

  @issue_page_size 50
  @max_error_body_log_bytes 1_000

  @query """
  query KarkhanaLinearPoll($projectSlug: String!, $stateNames: [String!]!, $first: Int!, $relationFirst: Int!, $after: String) {
  ...
  @query_by_ids """
  query KarkhanaLinearIssuesById($ids: [ID!]!, $first: Int!, $relationFirst: Int!) {
