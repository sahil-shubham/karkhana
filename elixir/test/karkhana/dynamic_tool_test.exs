defmodule Karkhana.Codex.DynamicToolTest do
  use Karkhana.TestSupport

  alias Karkhana.Codex.DynamicTool
  ...
  test "linear_graphql formats transport and auth failures" do
    ...
    assert Jason.decode!(missing_token["output"]) == %{
             "error" => %{
               "message" => "Karkhana is missing Linear auth. Set `linear.api_key` in `WORKFLOW.md` or export `LINEAR_API_KEY`."
             }
           }
